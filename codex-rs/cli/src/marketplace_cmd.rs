...
#[derive(Debug, Parser)]
#[command(bin_name = "cdx plugin marketplace")]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "cdx plugin marketplace add",
    after_help = "Examples:\n  cdx plugin marketplace add ./path/to/marketplace\n  cdx plugin marketplace add owner/repo --ref main\n  cdx plugin marketplace add https://github.com/owner/repo --sparse plugins/foo"
)]
...
#[derive(Debug, Parser)]
#[command(bin_name = "cdx plugin marketplace list")]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "cdx plugin marketplace upgrade",
    after_help = "Examples:\n  cdx plugin marketplace upgrade\n  cdx plugin marketplace upgrade debug"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "cdx plugin marketplace remove",
    after_help = "Example:\n  cdx plugin marketplace remove debug"
)]
