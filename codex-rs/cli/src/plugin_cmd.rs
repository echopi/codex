...
#[derive(Debug, Parser)]
#[command(
    bin_name = "cdx plugin add",
    after_help = "Examples:\n  cdx plugin add sample@debug\n  cdx plugin add sample --marketplace debug"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "cdx plugin list",
    after_help = "Examples:\n  cdx plugin list\n  cdx plugin list --marketplace debug\n  cdx plugin list --json\n  cdx plugin list --available --json"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "cdx plugin remove",
    after_help = "Examples:\n  cdx plugin remove sample@debug\n  cdx plugin remove sample --marketplace debug"
)]
